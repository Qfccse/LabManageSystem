<template>
    <div style="width: 1050px;margin: auto">
        <el-row class="lab_name">
            ...
            <el-col :span="8">
                <el-button type="primary" class="fr" style="margin-top: 20px" @click="click2CreateTemplate">发布报告模板</el-button>
            </el-col>
        </el-row>
        ...
        <div class="lab_right fl">
            ...
            <div class="clear_box" style="margin-left: 20px">
                ...
                <div v-if="guidebookList.length===0"
                    style="text-align: center;color: #666666;font-size: 30px;height: 80px;line-height: 80px">
                    暂无实验资料
                </div>
            </div>
        </div>
